...
#ifndef __WAIT_E1_CONFIG_H
#define __WAIT_E1_CONFIG_H

#include "MCUC_H1.h" /* include library configuration */

#ifndef WAIT_E1_CONFIG_USE_CYCLE_COUNTER
  #define WAIT_E1_CONFIG_USE_CYCLE_COUNTER  (0 && (MCUC_H1_CONFIG_CORTEX_M>=3))
    /*!< 1: Use hardware cycle counter (if present, only on Cortex-M3 or higher), 0: not using hardware cycle counter */
#endif

#ifndef WAIT_E1_CONFIG_USE_RTOS_WAIT
  #define WAIT_E1_CONFIG_USE_RTOS_WAIT  (0 && MCUC_H1_CONFIG_SDK_USE_FREERTOS)
